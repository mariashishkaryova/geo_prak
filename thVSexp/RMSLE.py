...
RESULT_FOLDER = os.path.join(SAVE_PASH, "results of RMSLE")
...
#   RMSLE
def rmsle(obs, pred, fraction=0.75):
...
def find_best_models(t_exp, m_exp, theory_files):
    ...
    for file in theory_files:
        ...
        error = rmsle(y_exp_win, y_th_win) 
...
def main():
    ...
    for exp in experiment_dirs:
        ...
        for f,_,_,e,_,_ in best_models:
            ...
            print(os.path.basename(f),"rmsle =",e)
