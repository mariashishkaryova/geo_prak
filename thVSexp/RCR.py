...
RESULT_FOLDER = os.path.join(SAVE_PASH, "results of RCR")
...
# RCR
def adjusted_r_squared(obs, pred, p=1, fraction=0.75):
...
def find_best_models(t_exp, m_exp, theory_files):
    ...
    for file in theory_files:
        ...
        error = adjusted_r_squared(y_exp_win, y_th_win) 
...
def main():
    ...
    for exp in experiment_dirs:
        ...
        for f,_,_,e,_,_ in best_models:
            ...
            print(os.path.basename(f),"adjusted_r_squared =",e)
